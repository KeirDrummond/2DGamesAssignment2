...
public class Constants {
    ...
    public static final int LEVEL_TIME = 45;
    ...
    public static final String BUBBLESIMPLE_PICKUP_PATH = "atlas/bubblesimple.atlas";

    public static final float MOONSHINE_SPEED = 5.0f;
    public static final float BUBBLE_SPEED = 25.0f;
